...
{
    public class GetAllUnpaidFinesQueryHandler : IRequestHandler<GetAllUnpaidFinesQuery, Result<PaginatedResult<FineDto>>>
    {
        private readonly IUnitOfWork unitOfWork;

        public GetAllUnpaidFinesQueryHandler(IUnitOfWork unitOfWork)
        {
            this.unitOfWork = unitOfWork;
        }


        public async Task<Result<PaginatedResult<FineDto>>> Handle(GetAllUnpaidFinesQuery request, CancellationToken cancellationToken)
        {
            ...
            var unpaidFines = await baseQuery
                .AsNoTracking()
