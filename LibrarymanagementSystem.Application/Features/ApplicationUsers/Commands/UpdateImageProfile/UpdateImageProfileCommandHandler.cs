...
namespace LibrarymanagementSystem.Application.Features.ApplicationUsers.Commands.UpdateImageProfile
{
    public class UpdateImageProfileCommandHandler : IRequestHandler<UpdateImageProfileCommand, Result<string>>
    {
        ...
        public UpdateImageProfileCommandHandler(UserManager<ApplicationUser> userManager, IFileService fileService, ICurrentUserService currentUserService)
        {
        ...
        public async Task<Result<string>> Handle(UpdateImageProfileCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                var resRemove=fileService.Remove(user.ProfileImage);
