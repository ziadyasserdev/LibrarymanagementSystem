...
namespace LibrarymanagementSystem.Application.Features.Publishers.Commands.UpdatePublisherLogo
{
    public class UpdatePublisherLogoCommandHandler : IRequestHandler<UpdatePublisherLogoCommand, Result<int>>
    {
        private readonly IUnitOfWork unitOfWork;
        private readonly IFileService fileService;

        public UpdatePublisherLogoCommandHandler(IUnitOfWork unitOfWork,IFileService fileService)
        {
            this.unitOfWork = unitOfWork;
            this.fileService = fileService;
        }
        public async Task<Result<int>> Handle(UpdatePublisherLogoCommand request, CancellationToken cancellationToken)
        {
