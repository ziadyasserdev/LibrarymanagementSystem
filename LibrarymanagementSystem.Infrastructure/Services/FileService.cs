...
namespace LibrarymanagementSystem.Infrastructure.Services
{
    public class FileService : IFileService
    {
     ...
     => UploadAsync(file, new []{ ".pdf", ".ppxt", ".docx" }, _settings.FileSizeInMB, _settings.FilesFolder);

        public  Task<Result<FileDto>> UploadImageAsync(IFormFile file)
      => UploadAsync(file, new[] { ".jpg", ".png", ".jpeg" } ,_settings.ImageSizeInMB,_settings.ImagesFolder);

        public Task<Result<FileDto>> UploadVideoAsync(IFormFile file)
    ...
    int maxSizeInMB)
        ...
        private async Task<Result<FileDto>> UploadAsync(
    IFormFile file,
    ...
    string folderName)
        {
            ...
            var fileDto = new FileDto
            {
                ...
                Url = $"{_settings.UploadsFolder}/{folderName}/{newName}"
            };
